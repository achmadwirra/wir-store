      ...
      >
        ...
        <div className="rounded-2xl border border-white/5 bg-gray-900/50 p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@wirstore.com"
                />
              </div>
            </div>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/10 py-3 text-sm text-gray-300 transition-colors hover:bg-white/5"
          >
          ...
          <div className="mt-6 rounded-xl border border-white/5 bg-white/[0.02] p-4">
            <p className="mb-2 text-xs font-medium text-gray-400">Demo Credentials:</p>
            <div className="space-y-1 text-xs text-gray-500">
              <p>Admin: admin@wirstore.com / password123</p>
              <p>Customer: customer@wirstore.com / password123</p>
            </div>
          </div>
        </div>
